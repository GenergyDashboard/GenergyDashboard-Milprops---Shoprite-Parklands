...
for Shoprite Parklands and stores it in data/irradiation_data.json.

Accumulates daily records over time so the dashboard can show
irradiation history alongside generation data.

API: https://api.open-meteo.com/v1/forecast
Location: Shoprite Parklands, Saldanha Bay, Western Cape
"""
...
# ── Configuration ──────────────────────────────────────────────────────────
LATITUDE = -33.815026895703326
LONGITUDE = 18.50075959819609
...
def main():
    print("🌤️  Shoprite Parklands - Irradiation Data")
    print("=" * 50)
