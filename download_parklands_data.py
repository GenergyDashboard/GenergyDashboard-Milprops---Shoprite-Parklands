"""
download_parklands_data.py

Downloads the daily Plant Report XLSX for Shoprite Parklands from the
FusionSolar portal via Playwright.

SITE CONFIG — edit these if the plant name in the FusionSolar portal changes:
  Search term (typed into the Plant name search box): 'Shoprite Parklands'
  Plant link text to click:                           'Shoprite Parklands'
  Output file:                                        data/parklands_raw.xlsx
...
def download_parklands_data():
    """Download Shoprite Parklands data from FusionSolar"""

    print("🚀 Starting Shoprite Parklands data download...")
    ...
    with sync_playwright() as playwright:
        ...
        try:
            ...
            # =========================================================
            # Step 6: Search for Shoprite Parklands
            # Try multiple selector strategies based on inspection
            # =========================================================
            print("🔎 Step 6: Searching for Shoprite Parklands...")
            ...
            human_delay(1, 2)
            type_human_like(search_field, "Shoprite Parklands")
            human_delay(2, 3)
            ...
            # =========================================================
            # Step 7: Click Shoprite Parklands
            # =========================================================
            print("🏢 Step 7: Selecting Shoprite Parklands...")
            try:
                page.get_by_role("link", name="Shoprite Parklands").click()
            except:
                # Fallback: find by text
                page.get_by_text("Shoprite Parklands").first.click()

            page.wait_for_load_state("networkidle", timeout=60000)
            human_delay(5, 8)
            random_mouse_movement(page)

            page.screenshot(path="04_parklands_station.png", full_page=True)
            ...
            download_path = data_dir / "parklands_raw.xlsx"
